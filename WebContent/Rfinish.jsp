...
<br>
Your subscription has been accepted. <br>
<FONT size= 5 color="green">Thank you!</FONT>
<br><br>
<a href="<%=request.getContextPath() %>/ViewReservedController?action=listReserved">You can view all your reserved rentals here. </a> <br>
